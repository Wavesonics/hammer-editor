	...
	path("/") {
		div(fomantic.pusher) {
			...
			div(fomantic.ui.inverted.vertical.segment) {
				div(fomantic.ui.center.aligned.container).innerHTML("Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.")
			}.addClasses("footer")
		}
	}
}
